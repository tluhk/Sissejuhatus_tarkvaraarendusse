...
Paberprototüüpimine on kõige kiirem, lihtsam ehk kõige vähem ressurssi nõudev viis kirelt visandada ideed. Igaüks suudab vedada pliiatsiga jälje paberile ja mingil kombel oma idee valmis sodida.  
...
[4] Agiilne arendus ehk Kanban, Scrum ja teised – kaasaegne lähenemisviis tarkvaraarenduses https://koren.ee/blogi/agiilne-arendus-ehk-kanban-scrum-ja-teised-kaasaegne-laehenemisviis-tarkvaraarenduses  
[5] Agiilne arendus - Vikipeedia https://et.wikipedia.org/wiki/Agiilne_arendus  
[6] [PDF] Agiilse lähenemise rakendusvõimaluste uurimine
...
## Kokkuvõte
Scrum või Kanban projekti seadistamine Githubis.
1) Loo repositoorium
2) Loo epikud
3) Konverdi vajalikud epiku osad issueteks
4) Loo labeli'id (epic, backend, frontend, optimization jne) ja milestonid (v1, v2 jne)
