...
```text
Probleem → uurimine → nõuded → planeerimine
   → disain → arendamine → testimine
...
## GitHub on meie läbiv töökeskkond

Kasutame GitHubi:

- failide hoidmiseks ja muutmiseks;
- muudatuste ajaloo hoidmiseks;
